...
[![Terraform Format](https://img.shields.io/badge/terraform-fmt-blue?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-security-group-web-aws/actions)
[![Terraform Validate](https://img.shields.io/badge/terraform-validate-blue?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-security-group-web-aws/actions)
[![TFLint](https://img.shields.io/badge/tflint-passing-brightgreen?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-security-group-web-aws/actions)
[![Terraform Test](https://img.shields.io/badge/tests-2%20passed-brightgreen?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-security-group-web-aws/actions)
[![Security Scan](https://img.shields.io/badge/trivy-passing-brightgreen?logo=aqua)](https://github.com/PlatformStackPulse/tf-molecule-security-group-web-aws/actions)
...
[![Documentation](https://img.shields.io/badge/docs-terraform--docs-blue?logo=readthedocs)](https://github.com/PlatformStackPulse/tf-molecule-security-group-web-aws/actions)
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_egress_all"></a> [egress\_all](#module\_egress\_all) | git::https://github.com/PlatformStackPulse/tf-atom-security-group-rule-aws.git | v1.1.0 |
| <a name="module_ingress_http"></a> [ingress\_http](#module\_ingress\_http) | git::https://github.com/PlatformStackPulse/tf-atom-security-group-rule-aws.git | v1.1.0 |
| <a name="module_ingress_https"></a> [ingress\_https](#module\_ingress\_https) | git::https://github.com/PlatformStackPulse/tf-atom-security-group-rule-aws.git | v1.1.0 |
| <a name="module_security_group"></a> [security\_group](#module\_security\_group) | git::https://github.com/PlatformStackPulse/tf-atom-security-group-aws.git | v1.1.0 |
...
| <a name="input_allowed_cidr"></a> [allowed\_cidr](#input\_allowed\_cidr) | CIDR block allowed to access HTTP/HTTPS | `string` | `"0.0.0.0/0"` | no |
